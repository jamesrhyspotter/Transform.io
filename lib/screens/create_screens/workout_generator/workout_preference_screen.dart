...
//MULTIPROVIDER IS REDUNDANT
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<PhysiqueScreenProvider>(
            create: (_) => PhysiqueScreenProvider()),
        ChangeNotifierProvider<WorkoutPreferencesProvider>(
            create: (_) => WorkoutPreferencesProvider()),
      ],
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding:
                              const EdgeInsets.only(right: 16.0, bottom: 24),
                          child: RaisedButton(
                            child: Text('Go',
                            ...
                            onPressed: () {
                              ...
                              print(screenProvider
                                  .generatedWorkout.outputExerciseList);
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder:
                                          (context) => /*ExerciseCardScreen(screenProvider.generatedWorkout)*/ SetWorkoutScreen(
                                              screenProvider
                                                  .generatedWorkout)));
                            },
                          ),
