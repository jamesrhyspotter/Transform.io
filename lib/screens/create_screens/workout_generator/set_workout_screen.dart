...
class SetWorkoutScreen extends StatelessWidget {
  ...
  SetWorkoutScreen(Workout inputWorkout) {
    ...
    for (int j = 0; j < this.workout.targetMuscles.length; j++) {
      ...
      for (int k = 0;
          k < eDb.getAllExercises(this.workout.targetMuscles[j]).length;
          k++) {
        optionExercises
            .add(eDb.getAllExercises(this.workout.targetMuscles[j])[k]);
      }
    }
  }
                ...
                FlatButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => Scaffold(body: RepCounter())));
                  },
                ),
              ],
            ),
                                                          ...
                                                          RaisedButton(
                                                            ...
                                                            onPressed: () {
                                                              ...
                                                              Navigator.push(
                                                                  context,
                                                                  MaterialPageRoute(
                                                                      builder: (context) => ExerciseCardScreen(
                                                                          this.workout,
                                                                          index)));
                                                            },
                                                            child: Row(
                                              ...
                                              itemBuilder:
                                                ...
                                                return Padding(
                                                  ...
                                                  child: Card(
                                                    ...
                                                    child: ListTile(
                                                      key: Key('$index2'),
                                                      leading: optionExercises[
                                                              index2]
                                                          .image,
                                                      title: Text(
                                                          '${optionExercises[index2].name}',
                                                          style: GoogleFonts
                                                              .montserrat()),
                                                      subtitle: Row(
                                                        children: [
                                                          Text(optionExercises[
                                                                  index2]
                                                              .targetMuscles[0]
                                                              .toString()),
                                                        ],
                      ...
                      FlatButton(
                          onPressed: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        ExerciseCardScreen(this.workout, 0)));
                          },
